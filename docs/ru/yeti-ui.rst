...
Destinations
~~~~~~~~~~~~
Направления (Destinations) в YETI предназначены для определения префиксов, которые могут быть обработаны системой и порядка вычесления стоимости звонков.

Атрибуты **Routing. Destinations**:
...
Routing
-------
    В этом пункте меню находятся объекты конфигурации непосредственно влияющие на поиск маршрута при коммутации вызова.ы
