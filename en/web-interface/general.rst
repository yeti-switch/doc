...
.. _general_information:
 ...
 YETI Web interface allows you to manage all possible entities in the system including CDRs, reporting, billing, routing, system configuration and others. It was developed using the most powerful and flexible web frameworks such as `Ruby on Rails <https://rubyonrails.org/>`_ and `Active Admin <https://activeadmin.info/>`_.
